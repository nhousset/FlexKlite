...
// Vérifie si un mot de passe a déjà été configuré
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$has_password) {
        ...
        if (empty($pass1)) {
            ...
            // On hache le mot de passe de façon sécurisée (ne jamais stocker en clair)
    ...
    <div class="login-card">
        ...
        <?php if (!$has_password): ?>
            ...
            <form method="POST">
                ...
                <button type="submit" style="background: #00875a;">Enregistrer et déverrouiller</button>
            </form>
